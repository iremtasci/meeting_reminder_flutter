...
class _SignUpViewState extends State<SignUpView> {
    ...
    if (validate()) {
      try {
        ...
        if (authFormType == AuthFormType.signIn) {
          ...
          _warning = "Şifre yenileme isteğin gönderilmiştir $_email";
          setState(() {
            authFormType = AuthFormType.signIn;
          });
        } else {
  ...
  AutoSizeText buildHeaderText() {
    ...
    if (authFormType == AuthFormType.signUp) {
      _headerText = "Yeni Hesap Oluştur";
    } else if (authFormType == AuthFormType.reset) {
      _headerText = "Şifreyi Sıfırla";
    } else {
  ...
  List<Widget> buildButtons() {
    ...
    if (authFormType == AuthFormType.signIn) {
      _switchButtonText = "Yeni Hesap Oluştur";
      ...
      _submitButtonText = "Kaydet";
    } else {
      _switchButtonText = "Hesabın Varsa Giriş Yap";
      _newFormState = "signIn";
